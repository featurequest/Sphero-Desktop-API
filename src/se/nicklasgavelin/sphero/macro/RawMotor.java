...
{
    public static final int MIN_SPEED = 0, MAX_SPEED = 255, MIN_DELAY = 0, MAX_DELAY = 255;
    private RawMotorCommand.MOTOR_MODE leftMode, rightMode;
    private int leftSpeed, rightSpeed, delay;

    /**
     * Create a raw motor macro with given headings for each of the two motors and a given speed.
